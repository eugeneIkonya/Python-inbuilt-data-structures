...
public class RegisterActivity extends AppCompatActivity {
    ...
    public EditText emailField, usernameField, passwordField;
    public TextView loginTxtView;

    private FirebaseAuth mAuth;
    private FirebaseDatabase database;
    private DatabaseReference userDetailsRefrence;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userDetailsRefrence = database.getReference().child("Users");
                ...
                if(!TextUtils.isEmpty(email) && !TextUtils.isEmpty(username) && !TextUtils.isEmpty(password) ){
                    mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            DatabaseReference current_user_db = userDetailsRefrence.child(user_id);
